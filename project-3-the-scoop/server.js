...
function AddNewComment (url,request){
...
if (existingComment){
  const cmtIds = database.articles[existingComment.articleId].commentIds;
  const usrIds = database.users[existingComment.username].commentIds;
